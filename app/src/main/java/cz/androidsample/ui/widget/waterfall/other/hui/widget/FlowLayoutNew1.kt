...
class FlowLayoutNew1(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) : ViewGroup(context, attrs, defStyleAttr, defStyleRes) {
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.HuiFlowLayout1).apply {
            val itemPadding = getDimension(R.styleable.HuiFlowLayout1_item_padding, 0f)
            itemDivideHorizontalAttr = getDimension(R.styleable.HuiFlowLayout1_item_divide_horizontal, itemPadding).toInt()
            itemDivideVerticalAttr = getDimension(R.styleable.HuiFlowLayout1_item_divide_vertical, itemPadding).toInt()
            itemPaddingFixable = getBoolean(R.styleable.HuiFlowLayout1_item_padding_fixable, false)
