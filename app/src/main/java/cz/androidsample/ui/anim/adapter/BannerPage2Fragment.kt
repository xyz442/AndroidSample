...
class BannerPage2Fragment:BaseBannerPageFragment(){
    ...
    override fun startPageAnimator() {
        ...
        val lightAnimator = alpha(lightLayout, 1f, 600)
        ...
        animatorSet = AnimatorSet().apply {
            ...
            if(!firstAnimator){
                ...
                play(animator1).with(lightAnimator)
                play(lightAnimator).before(animator5)
            } else {
            ...
            animator14.addListener(object : AnimatorListenerAdapter(){
